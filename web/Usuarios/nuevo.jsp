                            ...
                            <form action="../UsuariosController" method="POST">
                                <div class="con">
                                    ...
                                    <div class="text-center text-lg-start mt-4 pt-2 ">
                                        <button type="submit" class="log-in" name="accion" value="Guardar">Guardar Datos</button>
                                    </div>     
                                    <div class="other">
                                        <button class="btn submits frgt-pass" onclick="location.href='../UsuariosController?accion=Usuarios'"><-Regresar</button>                  
