...
<html>
    <head>
        <meta charset="utf-8">
        <title>error</title>
        <link href="CSS/estilo_pagerror.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <svg width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect id="background" x="30" y="26" width="1063" height="777" rx="20" fill="black" style="#background{border-radius:5px;}"/>
            <g id="stars">
